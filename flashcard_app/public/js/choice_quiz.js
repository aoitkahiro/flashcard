...
var Challenge = /*#__PURE__*/function () {
  function Challenge(data) {
    ...
    data.questions.forEach(function (question) {
      _this.questions.push(new ChoiceQuiz(question));
    });
  }
  ...
  _createClass(Challenge, [{
    ...
    value: function initDisplay() {
      drawElmFromTpl(gameStatusTpl, gameStatusElm, {
        status: message.pause
      });
      drawElmFromTpl(missCounterTpl, missCounterElm, {
        miss: challenge.missNum
      });
      drawElmFromTpl(askedCardsQuestionTpl, askedCardQuestionElm, {
    ...
    key: "flow",
    value: function () {
      var _flow = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var challengeTimer, _iterator, _step, question, questionTimer;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _iterator = _createForOfIteratorHelper(this.questions);
                _context.prev = 2;
...
var ChoiceQuiz = /*#__PURE__*/function () {
  function ChoiceQuiz(data) {
    _classCallCheck(this, ChoiceQuiz);
  ...
  _createClass(ChoiceQuiz, [{
    ...
    value: function generateSelections() {
      var selections = [].concat(_toConsumableArray(this.notAskedCards), [this.askedCard]); //シャッフルアルゴリズムFisher-Yates

      for (var i = selections.length - 1; i > 0; i--) {
        var j = Math.floor(Math.random() * (i + 1)); //random index

        var _ref = [selections[j], selections[i]];
        selections[i] = _ref[0];
        selections[j] = _ref[1];
      }
    ...
    value: function choose() {
      ...
      return new Promise(function (resolve) {
        var _iterator2 = _createForOfIteratorHelper(choiceElms),
            _step2;
    ...
    value: function initDisplay() {
      ...
      drawElmFromTpl(askedCardsQuestionTpl, askedCardQuestionElm, {
        question: this.askedCard.question
      });
    ...
    value: function showResult() {
      ...
      drawElmFromTpl(gameStatusTpl, gameStatusElm, {
        status: "".concat(message.pause, " ").concat(result)
      });
      drawElmFromTpl(missCounterTpl, missCounterElm, {
        miss: challenge.missNum
      });
...
var Timer = /*#__PURE__*/function () {
  function Timer(_ref2) {
    var _ref2$displayed = _ref2.displayed,
        displayed = _ref2$displayed === void 0 ? false : _ref2$displayed;
  ...
  _createClass(Timer, [{
    ...
    value: function start() {
      ...
      this.interval = setInterval(function () {
        _this3.ms += _this3.delay;

        if (_this3.displayed) {
          drawElmFromTpl(timerTpl, timerElm, {
            time: _this3.formatTime()
          });
        }
      }, this.delay);
    }
    ...
    value: function formatTime() {
      var hours = Math.floor(this.ms / 3600000);
      var minutes = Math.floor((this.ms - hours * 3600000) / 60000);
      var seconds = Math.floor((this.ms - hours * 3600000 - minutes * 60000) / 1000);
      var ds = Math.floor((this.ms - hours * 3600000 - minutes * 60000 - seconds * 1000) / this.delay);
...
var challenge = new Challenge(Laravel.challenge);
console.log(challenge);
var gameStatusElm = document.getElementById('game-status');
var timerElm = document.getElementById('timer');
var missCounterElm = document.getElementById('miss-counter');
...
var askedCardsQuestionTpl = document.getElementById('asked-card-question-tpl');
var message = {
  pause: "PAUSE",
  playing: "PLAYING",
  unknown: "???",
...
function _main() {
  _main = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
...
function _countDown() {
  _countDown = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(sec) {
    var i;
